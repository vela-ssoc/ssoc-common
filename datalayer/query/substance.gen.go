...
func (s *substance) WithContext(ctx context.Context) ISubstanceDo {
...
type ISubstanceDo interface {
	gen.SubQuery
	Debug() ISubstanceDo
	WithContext(ctx context.Context) ISubstanceDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ISubstanceDo
	WriteDB() ISubstanceDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ISubstanceDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ISubstanceDo
	Not(conds ...gen.Condition) ISubstanceDo
	Or(conds ...gen.Condition) ISubstanceDo
	Select(conds ...field.Expr) ISubstanceDo
	Where(conds ...gen.Condition) ISubstanceDo
	Order(conds ...field.Expr) ISubstanceDo
	Distinct(cols ...field.Expr) ISubstanceDo
	Omit(cols ...field.Expr) ISubstanceDo
	Join(table schema.Tabler, on ...field.Expr) ISubstanceDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ISubstanceDo
	RightJoin(table schema.Tabler, on ...field.Expr) ISubstanceDo
	Group(cols ...field.Expr) ISubstanceDo
	Having(conds ...gen.Condition) ISubstanceDo
	Limit(limit int) ISubstanceDo
	Offset(offset int) ISubstanceDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ISubstanceDo
	Unscoped() ISubstanceDo
	Create(values ...*model.Substance) error
	CreateInBatches(values []*model.Substance, batchSize int) error
	Save(values ...*model.Substance) error
	First() (*model.Substance, error)
	Take() (*model.Substance, error)
	Last() (*model.Substance, error)
	Find() ([]*model.Substance, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Substance, err error)
	FindInBatches(result *[]*model.Substance, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Substance) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ISubstanceDo
	Assign(attrs ...field.AssignExpr) ISubstanceDo
	Joins(fields ...field.RelationField) ISubstanceDo
	Preload(fields ...field.RelationField) ISubstanceDo
	FirstOrInit() (*model.Substance, error)
	FirstOrCreate() (*model.Substance, error)
	FindByPage(offset int, limit int) (result []*model.Substance, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ISubstanceDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (s substanceDo) Debug() ISubstanceDo {
	return s.withDO(s.DO.Debug())
}

func (s substanceDo) WithContext(ctx context.Context) ISubstanceDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s substanceDo) ReadDB() ISubstanceDo {
	return s.Clauses(dbresolver.Read)
}

func (s substanceDo) WriteDB() ISubstanceDo {
	return s.Clauses(dbresolver.Write)
}

func (s substanceDo) Session(config *gorm.Session) ISubstanceDo {
	return s.withDO(s.DO.Session(config))
}

func (s substanceDo) Clauses(conds ...clause.Expression) ISubstanceDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s substanceDo) Returning(value interface{}, columns ...string) ISubstanceDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s substanceDo) Not(conds ...gen.Condition) ISubstanceDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s substanceDo) Or(conds ...gen.Condition) ISubstanceDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s substanceDo) Select(conds ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s substanceDo) Where(conds ...gen.Condition) ISubstanceDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s substanceDo) Order(conds ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s substanceDo) Distinct(cols ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s substanceDo) Omit(cols ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s substanceDo) Join(table schema.Tabler, on ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s substanceDo) LeftJoin(table schema.Tabler, on ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s substanceDo) RightJoin(table schema.Tabler, on ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s substanceDo) Group(cols ...field.Expr) ISubstanceDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s substanceDo) Having(conds ...gen.Condition) ISubstanceDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s substanceDo) Limit(limit int) ISubstanceDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s substanceDo) Offset(offset int) ISubstanceDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s substanceDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ISubstanceDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s substanceDo) Unscoped() ISubstanceDo {
...
func (s substanceDo) Attrs(attrs ...field.AssignExpr) ISubstanceDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s substanceDo) Assign(attrs ...field.AssignExpr) ISubstanceDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s substanceDo) Joins(fields ...field.RelationField) ISubstanceDo {
...
func (s substanceDo) Preload(fields ...field.RelationField) ISubstanceDo {
	for _, _f := range fields {

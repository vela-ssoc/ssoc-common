...
func (b *brokerBin) WithContext(ctx context.Context) IBrokerBinDo {
...
type IBrokerBinDo interface {
	gen.SubQuery
	Debug() IBrokerBinDo
	WithContext(ctx context.Context) IBrokerBinDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IBrokerBinDo
	WriteDB() IBrokerBinDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IBrokerBinDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IBrokerBinDo
	Not(conds ...gen.Condition) IBrokerBinDo
	Or(conds ...gen.Condition) IBrokerBinDo
	Select(conds ...field.Expr) IBrokerBinDo
	Where(conds ...gen.Condition) IBrokerBinDo
	Order(conds ...field.Expr) IBrokerBinDo
	Distinct(cols ...field.Expr) IBrokerBinDo
	Omit(cols ...field.Expr) IBrokerBinDo
	Join(table schema.Tabler, on ...field.Expr) IBrokerBinDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IBrokerBinDo
	RightJoin(table schema.Tabler, on ...field.Expr) IBrokerBinDo
	Group(cols ...field.Expr) IBrokerBinDo
	Having(conds ...gen.Condition) IBrokerBinDo
	Limit(limit int) IBrokerBinDo
	Offset(offset int) IBrokerBinDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IBrokerBinDo
	Unscoped() IBrokerBinDo
	Create(values ...*model.BrokerBin) error
	CreateInBatches(values []*model.BrokerBin, batchSize int) error
	Save(values ...*model.BrokerBin) error
	First() (*model.BrokerBin, error)
	Take() (*model.BrokerBin, error)
	Last() (*model.BrokerBin, error)
	Find() ([]*model.BrokerBin, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.BrokerBin, err error)
	FindInBatches(result *[]*model.BrokerBin, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.BrokerBin) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IBrokerBinDo
	Assign(attrs ...field.AssignExpr) IBrokerBinDo
	Joins(fields ...field.RelationField) IBrokerBinDo
	Preload(fields ...field.RelationField) IBrokerBinDo
	FirstOrInit() (*model.BrokerBin, error)
	FirstOrCreate() (*model.BrokerBin, error)
	FindByPage(offset int, limit int) (result []*model.BrokerBin, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IBrokerBinDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (b brokerBinDo) Debug() IBrokerBinDo {
	return b.withDO(b.DO.Debug())
}

func (b brokerBinDo) WithContext(ctx context.Context) IBrokerBinDo {
	return b.withDO(b.DO.WithContext(ctx))
}

func (b brokerBinDo) ReadDB() IBrokerBinDo {
	return b.Clauses(dbresolver.Read)
}

func (b brokerBinDo) WriteDB() IBrokerBinDo {
	return b.Clauses(dbresolver.Write)
}

func (b brokerBinDo) Session(config *gorm.Session) IBrokerBinDo {
	return b.withDO(b.DO.Session(config))
}

func (b brokerBinDo) Clauses(conds ...clause.Expression) IBrokerBinDo {
	return b.withDO(b.DO.Clauses(conds...))
}

func (b brokerBinDo) Returning(value interface{}, columns ...string) IBrokerBinDo {
	return b.withDO(b.DO.Returning(value, columns...))
}

func (b brokerBinDo) Not(conds ...gen.Condition) IBrokerBinDo {
	return b.withDO(b.DO.Not(conds...))
}

func (b brokerBinDo) Or(conds ...gen.Condition) IBrokerBinDo {
	return b.withDO(b.DO.Or(conds...))
}

func (b brokerBinDo) Select(conds ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Select(conds...))
}

func (b brokerBinDo) Where(conds ...gen.Condition) IBrokerBinDo {
	return b.withDO(b.DO.Where(conds...))
}

func (b brokerBinDo) Order(conds ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Order(conds...))
}

func (b brokerBinDo) Distinct(cols ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Distinct(cols...))
}

func (b brokerBinDo) Omit(cols ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Omit(cols...))
}

func (b brokerBinDo) Join(table schema.Tabler, on ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Join(table, on...))
}

func (b brokerBinDo) LeftJoin(table schema.Tabler, on ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.LeftJoin(table, on...))
}

func (b brokerBinDo) RightJoin(table schema.Tabler, on ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.RightJoin(table, on...))
}

func (b brokerBinDo) Group(cols ...field.Expr) IBrokerBinDo {
	return b.withDO(b.DO.Group(cols...))
}

func (b brokerBinDo) Having(conds ...gen.Condition) IBrokerBinDo {
	return b.withDO(b.DO.Having(conds...))
}

func (b brokerBinDo) Limit(limit int) IBrokerBinDo {
	return b.withDO(b.DO.Limit(limit))
}

func (b brokerBinDo) Offset(offset int) IBrokerBinDo {
	return b.withDO(b.DO.Offset(offset))
}

func (b brokerBinDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IBrokerBinDo {
	return b.withDO(b.DO.Scopes(funcs...))
}

func (b brokerBinDo) Unscoped() IBrokerBinDo {
...
func (b brokerBinDo) Attrs(attrs ...field.AssignExpr) IBrokerBinDo {
	return b.withDO(b.DO.Attrs(attrs...))
}

func (b brokerBinDo) Assign(attrs ...field.AssignExpr) IBrokerBinDo {
	return b.withDO(b.DO.Assign(attrs...))
}

func (b brokerBinDo) Joins(fields ...field.RelationField) IBrokerBinDo {
...
func (b brokerBinDo) Preload(fields ...field.RelationField) IBrokerBinDo {
	for _, _f := range fields {

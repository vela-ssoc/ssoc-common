...
func (b *broker) WithContext(ctx context.Context) IBrokerDo { return b.brokerDo.WithContext(ctx) }
...
type IBrokerDo interface {
	gen.SubQuery
	Debug() IBrokerDo
	WithContext(ctx context.Context) IBrokerDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IBrokerDo
	WriteDB() IBrokerDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IBrokerDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IBrokerDo
	Not(conds ...gen.Condition) IBrokerDo
	Or(conds ...gen.Condition) IBrokerDo
	Select(conds ...field.Expr) IBrokerDo
	Where(conds ...gen.Condition) IBrokerDo
	Order(conds ...field.Expr) IBrokerDo
	Distinct(cols ...field.Expr) IBrokerDo
	Omit(cols ...field.Expr) IBrokerDo
	Join(table schema.Tabler, on ...field.Expr) IBrokerDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IBrokerDo
	RightJoin(table schema.Tabler, on ...field.Expr) IBrokerDo
	Group(cols ...field.Expr) IBrokerDo
	Having(conds ...gen.Condition) IBrokerDo
	Limit(limit int) IBrokerDo
	Offset(offset int) IBrokerDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IBrokerDo
	Unscoped() IBrokerDo
	Create(values ...*model.Broker) error
	CreateInBatches(values []*model.Broker, batchSize int) error
	Save(values ...*model.Broker) error
	First() (*model.Broker, error)
	Take() (*model.Broker, error)
	Last() (*model.Broker, error)
	Find() ([]*model.Broker, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Broker, err error)
	FindInBatches(result *[]*model.Broker, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Broker) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IBrokerDo
	Assign(attrs ...field.AssignExpr) IBrokerDo
	Joins(fields ...field.RelationField) IBrokerDo
	Preload(fields ...field.RelationField) IBrokerDo
	FirstOrInit() (*model.Broker, error)
	FirstOrCreate() (*model.Broker, error)
	FindByPage(offset int, limit int) (result []*model.Broker, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IBrokerDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (b brokerDo) Debug() IBrokerDo {
	return b.withDO(b.DO.Debug())
}

func (b brokerDo) WithContext(ctx context.Context) IBrokerDo {
	return b.withDO(b.DO.WithContext(ctx))
}

func (b brokerDo) ReadDB() IBrokerDo {
	return b.Clauses(dbresolver.Read)
}

func (b brokerDo) WriteDB() IBrokerDo {
	return b.Clauses(dbresolver.Write)
}

func (b brokerDo) Session(config *gorm.Session) IBrokerDo {
	return b.withDO(b.DO.Session(config))
}

func (b brokerDo) Clauses(conds ...clause.Expression) IBrokerDo {
	return b.withDO(b.DO.Clauses(conds...))
}

func (b brokerDo) Returning(value interface{}, columns ...string) IBrokerDo {
	return b.withDO(b.DO.Returning(value, columns...))
}

func (b brokerDo) Not(conds ...gen.Condition) IBrokerDo {
	return b.withDO(b.DO.Not(conds...))
}

func (b brokerDo) Or(conds ...gen.Condition) IBrokerDo {
	return b.withDO(b.DO.Or(conds...))
}

func (b brokerDo) Select(conds ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Select(conds...))
}

func (b brokerDo) Where(conds ...gen.Condition) IBrokerDo {
	return b.withDO(b.DO.Where(conds...))
}

func (b brokerDo) Order(conds ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Order(conds...))
}

func (b brokerDo) Distinct(cols ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Distinct(cols...))
}

func (b brokerDo) Omit(cols ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Omit(cols...))
}

func (b brokerDo) Join(table schema.Tabler, on ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Join(table, on...))
}

func (b brokerDo) LeftJoin(table schema.Tabler, on ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.LeftJoin(table, on...))
}

func (b brokerDo) RightJoin(table schema.Tabler, on ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.RightJoin(table, on...))
}

func (b brokerDo) Group(cols ...field.Expr) IBrokerDo {
	return b.withDO(b.DO.Group(cols...))
}

func (b brokerDo) Having(conds ...gen.Condition) IBrokerDo {
	return b.withDO(b.DO.Having(conds...))
}

func (b brokerDo) Limit(limit int) IBrokerDo {
	return b.withDO(b.DO.Limit(limit))
}

func (b brokerDo) Offset(offset int) IBrokerDo {
	return b.withDO(b.DO.Offset(offset))
}

func (b brokerDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IBrokerDo {
	return b.withDO(b.DO.Scopes(funcs...))
}

func (b brokerDo) Unscoped() IBrokerDo {
...
func (b brokerDo) Attrs(attrs ...field.AssignExpr) IBrokerDo {
	return b.withDO(b.DO.Attrs(attrs...))
}

func (b brokerDo) Assign(attrs ...field.AssignExpr) IBrokerDo {
	return b.withDO(b.DO.Assign(attrs...))
}

func (b brokerDo) Joins(fields ...field.RelationField) IBrokerDo {
...
func (b brokerDo) Preload(fields ...field.RelationField) IBrokerDo {
	for _, _f := range fields {

...
func (t *taskExecute) WithContext(ctx context.Context) ITaskExecuteDo {
...
type ITaskExecuteDo interface {
	gen.SubQuery
	Debug() ITaskExecuteDo
	WithContext(ctx context.Context) ITaskExecuteDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ITaskExecuteDo
	WriteDB() ITaskExecuteDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITaskExecuteDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ITaskExecuteDo
	Not(conds ...gen.Condition) ITaskExecuteDo
	Or(conds ...gen.Condition) ITaskExecuteDo
	Select(conds ...field.Expr) ITaskExecuteDo
	Where(conds ...gen.Condition) ITaskExecuteDo
	Order(conds ...field.Expr) ITaskExecuteDo
	Distinct(cols ...field.Expr) ITaskExecuteDo
	Omit(cols ...field.Expr) ITaskExecuteDo
	Join(table schema.Tabler, on ...field.Expr) ITaskExecuteDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteDo
	RightJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteDo
	Group(cols ...field.Expr) ITaskExecuteDo
	Having(conds ...gen.Condition) ITaskExecuteDo
	Limit(limit int) ITaskExecuteDo
	Offset(offset int) ITaskExecuteDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ITaskExecuteDo
	Unscoped() ITaskExecuteDo
	Create(values ...*model.TaskExecute) error
	CreateInBatches(values []*model.TaskExecute, batchSize int) error
	Save(values ...*model.TaskExecute) error
	First() (*model.TaskExecute, error)
	Take() (*model.TaskExecute, error)
	Last() (*model.TaskExecute, error)
	Find() ([]*model.TaskExecute, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TaskExecute, err error)
	FindInBatches(result *[]*model.TaskExecute, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TaskExecute) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ITaskExecuteDo
	Assign(attrs ...field.AssignExpr) ITaskExecuteDo
	Joins(fields ...field.RelationField) ITaskExecuteDo
	Preload(fields ...field.RelationField) ITaskExecuteDo
	FirstOrInit() (*model.TaskExecute, error)
	FirstOrCreate() (*model.TaskExecute, error)
	FindByPage(offset int, limit int) (result []*model.TaskExecute, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ITaskExecuteDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (t taskExecuteDo) Debug() ITaskExecuteDo {
	return t.withDO(t.DO.Debug())
}

func (t taskExecuteDo) WithContext(ctx context.Context) ITaskExecuteDo {
	return t.withDO(t.DO.WithContext(ctx))
}

func (t taskExecuteDo) ReadDB() ITaskExecuteDo {
	return t.Clauses(dbresolver.Read)
}

func (t taskExecuteDo) WriteDB() ITaskExecuteDo {
	return t.Clauses(dbresolver.Write)
}

func (t taskExecuteDo) Session(config *gorm.Session) ITaskExecuteDo {
	return t.withDO(t.DO.Session(config))
}

func (t taskExecuteDo) Clauses(conds ...clause.Expression) ITaskExecuteDo {
	return t.withDO(t.DO.Clauses(conds...))
}

func (t taskExecuteDo) Returning(value interface{}, columns ...string) ITaskExecuteDo {
	return t.withDO(t.DO.Returning(value, columns...))
}

func (t taskExecuteDo) Not(conds ...gen.Condition) ITaskExecuteDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t taskExecuteDo) Or(conds ...gen.Condition) ITaskExecuteDo {
	return t.withDO(t.DO.Or(conds...))
}

func (t taskExecuteDo) Select(conds ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Select(conds...))
}

func (t taskExecuteDo) Where(conds ...gen.Condition) ITaskExecuteDo {
	return t.withDO(t.DO.Where(conds...))
}

func (t taskExecuteDo) Order(conds ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Order(conds...))
}

func (t taskExecuteDo) Distinct(cols ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Distinct(cols...))
}

func (t taskExecuteDo) Omit(cols ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Omit(cols...))
}

func (t taskExecuteDo) Join(table schema.Tabler, on ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Join(table, on...))
}

func (t taskExecuteDo) LeftJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.LeftJoin(table, on...))
}

func (t taskExecuteDo) RightJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.RightJoin(table, on...))
}

func (t taskExecuteDo) Group(cols ...field.Expr) ITaskExecuteDo {
	return t.withDO(t.DO.Group(cols...))
}

func (t taskExecuteDo) Having(conds ...gen.Condition) ITaskExecuteDo {
	return t.withDO(t.DO.Having(conds...))
}

func (t taskExecuteDo) Limit(limit int) ITaskExecuteDo {
	return t.withDO(t.DO.Limit(limit))
}

func (t taskExecuteDo) Offset(offset int) ITaskExecuteDo {
	return t.withDO(t.DO.Offset(offset))
}

func (t taskExecuteDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ITaskExecuteDo {
	return t.withDO(t.DO.Scopes(funcs...))
}

func (t taskExecuteDo) Unscoped() ITaskExecuteDo {
...
func (t taskExecuteDo) Attrs(attrs ...field.AssignExpr) ITaskExecuteDo {
	return t.withDO(t.DO.Attrs(attrs...))
}

func (t taskExecuteDo) Assign(attrs ...field.AssignExpr) ITaskExecuteDo {
	return t.withDO(t.DO.Assign(attrs...))
}

func (t taskExecuteDo) Joins(fields ...field.RelationField) ITaskExecuteDo {
...
func (t taskExecuteDo) Preload(fields ...field.RelationField) ITaskExecuteDo {
	for _, _f := range fields {

...
func (s *sBOMComponent) WithContext(ctx context.Context) ISBOMComponentDo {
...
type ISBOMComponentDo interface {
	gen.SubQuery
	Debug() ISBOMComponentDo
	WithContext(ctx context.Context) ISBOMComponentDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ISBOMComponentDo
	WriteDB() ISBOMComponentDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ISBOMComponentDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ISBOMComponentDo
	Not(conds ...gen.Condition) ISBOMComponentDo
	Or(conds ...gen.Condition) ISBOMComponentDo
	Select(conds ...field.Expr) ISBOMComponentDo
	Where(conds ...gen.Condition) ISBOMComponentDo
	Order(conds ...field.Expr) ISBOMComponentDo
	Distinct(cols ...field.Expr) ISBOMComponentDo
	Omit(cols ...field.Expr) ISBOMComponentDo
	Join(table schema.Tabler, on ...field.Expr) ISBOMComponentDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMComponentDo
	RightJoin(table schema.Tabler, on ...field.Expr) ISBOMComponentDo
	Group(cols ...field.Expr) ISBOMComponentDo
	Having(conds ...gen.Condition) ISBOMComponentDo
	Limit(limit int) ISBOMComponentDo
	Offset(offset int) ISBOMComponentDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMComponentDo
	Unscoped() ISBOMComponentDo
	Create(values ...*model.SBOMComponent) error
	CreateInBatches(values []*model.SBOMComponent, batchSize int) error
	Save(values ...*model.SBOMComponent) error
	First() (*model.SBOMComponent, error)
	Take() (*model.SBOMComponent, error)
	Last() (*model.SBOMComponent, error)
	Find() ([]*model.SBOMComponent, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SBOMComponent, err error)
	FindInBatches(result *[]*model.SBOMComponent, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SBOMComponent) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ISBOMComponentDo
	Assign(attrs ...field.AssignExpr) ISBOMComponentDo
	Joins(fields ...field.RelationField) ISBOMComponentDo
	Preload(fields ...field.RelationField) ISBOMComponentDo
	FirstOrInit() (*model.SBOMComponent, error)
	FirstOrCreate() (*model.SBOMComponent, error)
	FindByPage(offset int, limit int) (result []*model.SBOMComponent, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ISBOMComponentDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (s sBOMComponentDo) Debug() ISBOMComponentDo {
	return s.withDO(s.DO.Debug())
}

func (s sBOMComponentDo) WithContext(ctx context.Context) ISBOMComponentDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s sBOMComponentDo) ReadDB() ISBOMComponentDo {
	return s.Clauses(dbresolver.Read)
}

func (s sBOMComponentDo) WriteDB() ISBOMComponentDo {
	return s.Clauses(dbresolver.Write)
}

func (s sBOMComponentDo) Session(config *gorm.Session) ISBOMComponentDo {
	return s.withDO(s.DO.Session(config))
}

func (s sBOMComponentDo) Clauses(conds ...clause.Expression) ISBOMComponentDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s sBOMComponentDo) Returning(value interface{}, columns ...string) ISBOMComponentDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s sBOMComponentDo) Not(conds ...gen.Condition) ISBOMComponentDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s sBOMComponentDo) Or(conds ...gen.Condition) ISBOMComponentDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s sBOMComponentDo) Select(conds ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s sBOMComponentDo) Where(conds ...gen.Condition) ISBOMComponentDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s sBOMComponentDo) Order(conds ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s sBOMComponentDo) Distinct(cols ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s sBOMComponentDo) Omit(cols ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s sBOMComponentDo) Join(table schema.Tabler, on ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s sBOMComponentDo) LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s sBOMComponentDo) RightJoin(table schema.Tabler, on ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s sBOMComponentDo) Group(cols ...field.Expr) ISBOMComponentDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s sBOMComponentDo) Having(conds ...gen.Condition) ISBOMComponentDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s sBOMComponentDo) Limit(limit int) ISBOMComponentDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s sBOMComponentDo) Offset(offset int) ISBOMComponentDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s sBOMComponentDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMComponentDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s sBOMComponentDo) Unscoped() ISBOMComponentDo {
...
func (s sBOMComponentDo) Attrs(attrs ...field.AssignExpr) ISBOMComponentDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s sBOMComponentDo) Assign(attrs ...field.AssignExpr) ISBOMComponentDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s sBOMComponentDo) Joins(fields ...field.RelationField) ISBOMComponentDo {
...
func (s sBOMComponentDo) Preload(fields ...field.RelationField) ISBOMComponentDo {
	for _, _f := range fields {

...
func (r *risk) WithContext(ctx context.Context) IRiskDo { return r.riskDo.WithContext(ctx) }
...
type IRiskDo interface {
	gen.SubQuery
	Debug() IRiskDo
	WithContext(ctx context.Context) IRiskDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IRiskDo
	WriteDB() IRiskDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IRiskDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IRiskDo
	Not(conds ...gen.Condition) IRiskDo
	Or(conds ...gen.Condition) IRiskDo
	Select(conds ...field.Expr) IRiskDo
	Where(conds ...gen.Condition) IRiskDo
	Order(conds ...field.Expr) IRiskDo
	Distinct(cols ...field.Expr) IRiskDo
	Omit(cols ...field.Expr) IRiskDo
	Join(table schema.Tabler, on ...field.Expr) IRiskDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IRiskDo
	RightJoin(table schema.Tabler, on ...field.Expr) IRiskDo
	Group(cols ...field.Expr) IRiskDo
	Having(conds ...gen.Condition) IRiskDo
	Limit(limit int) IRiskDo
	Offset(offset int) IRiskDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IRiskDo
	Unscoped() IRiskDo
	Create(values ...*model.Risk) error
	CreateInBatches(values []*model.Risk, batchSize int) error
	Save(values ...*model.Risk) error
	First() (*model.Risk, error)
	Take() (*model.Risk, error)
	Last() (*model.Risk, error)
	Find() ([]*model.Risk, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Risk, err error)
	FindInBatches(result *[]*model.Risk, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Risk) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IRiskDo
	Assign(attrs ...field.AssignExpr) IRiskDo
	Joins(fields ...field.RelationField) IRiskDo
	Preload(fields ...field.RelationField) IRiskDo
	FirstOrInit() (*model.Risk, error)
	FirstOrCreate() (*model.Risk, error)
	FindByPage(offset int, limit int) (result []*model.Risk, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IRiskDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (r riskDo) Debug() IRiskDo {
	return r.withDO(r.DO.Debug())
}

func (r riskDo) WithContext(ctx context.Context) IRiskDo {
	return r.withDO(r.DO.WithContext(ctx))
}

func (r riskDo) ReadDB() IRiskDo {
	return r.Clauses(dbresolver.Read)
}

func (r riskDo) WriteDB() IRiskDo {
	return r.Clauses(dbresolver.Write)
}

func (r riskDo) Session(config *gorm.Session) IRiskDo {
	return r.withDO(r.DO.Session(config))
}

func (r riskDo) Clauses(conds ...clause.Expression) IRiskDo {
	return r.withDO(r.DO.Clauses(conds...))
}

func (r riskDo) Returning(value interface{}, columns ...string) IRiskDo {
	return r.withDO(r.DO.Returning(value, columns...))
}

func (r riskDo) Not(conds ...gen.Condition) IRiskDo {
	return r.withDO(r.DO.Not(conds...))
}

func (r riskDo) Or(conds ...gen.Condition) IRiskDo {
	return r.withDO(r.DO.Or(conds...))
}

func (r riskDo) Select(conds ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Select(conds...))
}

func (r riskDo) Where(conds ...gen.Condition) IRiskDo {
	return r.withDO(r.DO.Where(conds...))
}

func (r riskDo) Order(conds ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Order(conds...))
}

func (r riskDo) Distinct(cols ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Distinct(cols...))
}

func (r riskDo) Omit(cols ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Omit(cols...))
}

func (r riskDo) Join(table schema.Tabler, on ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Join(table, on...))
}

func (r riskDo) LeftJoin(table schema.Tabler, on ...field.Expr) IRiskDo {
	return r.withDO(r.DO.LeftJoin(table, on...))
}

func (r riskDo) RightJoin(table schema.Tabler, on ...field.Expr) IRiskDo {
	return r.withDO(r.DO.RightJoin(table, on...))
}

func (r riskDo) Group(cols ...field.Expr) IRiskDo {
	return r.withDO(r.DO.Group(cols...))
}

func (r riskDo) Having(conds ...gen.Condition) IRiskDo {
	return r.withDO(r.DO.Having(conds...))
}

func (r riskDo) Limit(limit int) IRiskDo {
	return r.withDO(r.DO.Limit(limit))
}

func (r riskDo) Offset(offset int) IRiskDo {
	return r.withDO(r.DO.Offset(offset))
}

func (r riskDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IRiskDo {
	return r.withDO(r.DO.Scopes(funcs...))
}

func (r riskDo) Unscoped() IRiskDo {
...
func (r riskDo) Attrs(attrs ...field.AssignExpr) IRiskDo {
	return r.withDO(r.DO.Attrs(attrs...))
}

func (r riskDo) Assign(attrs ...field.AssignExpr) IRiskDo {
	return r.withDO(r.DO.Assign(attrs...))
}

func (r riskDo) Joins(fields ...field.RelationField) IRiskDo {
...
func (r riskDo) Preload(fields ...field.RelationField) IRiskDo {
	for _, _f := range fields {

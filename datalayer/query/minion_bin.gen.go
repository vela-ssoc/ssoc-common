...
func (m *minionBin) WithContext(ctx context.Context) IMinionBinDo {
...
type IMinionBinDo interface {
	gen.SubQuery
	Debug() IMinionBinDo
	WithContext(ctx context.Context) IMinionBinDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IMinionBinDo
	WriteDB() IMinionBinDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IMinionBinDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IMinionBinDo
	Not(conds ...gen.Condition) IMinionBinDo
	Or(conds ...gen.Condition) IMinionBinDo
	Select(conds ...field.Expr) IMinionBinDo
	Where(conds ...gen.Condition) IMinionBinDo
	Order(conds ...field.Expr) IMinionBinDo
	Distinct(cols ...field.Expr) IMinionBinDo
	Omit(cols ...field.Expr) IMinionBinDo
	Join(table schema.Tabler, on ...field.Expr) IMinionBinDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IMinionBinDo
	RightJoin(table schema.Tabler, on ...field.Expr) IMinionBinDo
	Group(cols ...field.Expr) IMinionBinDo
	Having(conds ...gen.Condition) IMinionBinDo
	Limit(limit int) IMinionBinDo
	Offset(offset int) IMinionBinDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionBinDo
	Unscoped() IMinionBinDo
	Create(values ...*model.MinionBin) error
	CreateInBatches(values []*model.MinionBin, batchSize int) error
	Save(values ...*model.MinionBin) error
	First() (*model.MinionBin, error)
	Take() (*model.MinionBin, error)
	Last() (*model.MinionBin, error)
	Find() ([]*model.MinionBin, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.MinionBin, err error)
	FindInBatches(result *[]*model.MinionBin, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.MinionBin) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IMinionBinDo
	Assign(attrs ...field.AssignExpr) IMinionBinDo
	Joins(fields ...field.RelationField) IMinionBinDo
	Preload(fields ...field.RelationField) IMinionBinDo
	FirstOrInit() (*model.MinionBin, error)
	FirstOrCreate() (*model.MinionBin, error)
	FindByPage(offset int, limit int) (result []*model.MinionBin, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IMinionBinDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (m minionBinDo) Debug() IMinionBinDo {
	return m.withDO(m.DO.Debug())
}

func (m minionBinDo) WithContext(ctx context.Context) IMinionBinDo {
	return m.withDO(m.DO.WithContext(ctx))
}

func (m minionBinDo) ReadDB() IMinionBinDo {
	return m.Clauses(dbresolver.Read)
}

func (m minionBinDo) WriteDB() IMinionBinDo {
	return m.Clauses(dbresolver.Write)
}

func (m minionBinDo) Session(config *gorm.Session) IMinionBinDo {
	return m.withDO(m.DO.Session(config))
}

func (m minionBinDo) Clauses(conds ...clause.Expression) IMinionBinDo {
	return m.withDO(m.DO.Clauses(conds...))
}

func (m minionBinDo) Returning(value interface{}, columns ...string) IMinionBinDo {
	return m.withDO(m.DO.Returning(value, columns...))
}

func (m minionBinDo) Not(conds ...gen.Condition) IMinionBinDo {
	return m.withDO(m.DO.Not(conds...))
}

func (m minionBinDo) Or(conds ...gen.Condition) IMinionBinDo {
	return m.withDO(m.DO.Or(conds...))
}

func (m minionBinDo) Select(conds ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Select(conds...))
}

func (m minionBinDo) Where(conds ...gen.Condition) IMinionBinDo {
	return m.withDO(m.DO.Where(conds...))
}

func (m minionBinDo) Order(conds ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Order(conds...))
}

func (m minionBinDo) Distinct(cols ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Distinct(cols...))
}

func (m minionBinDo) Omit(cols ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Omit(cols...))
}

func (m minionBinDo) Join(table schema.Tabler, on ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Join(table, on...))
}

func (m minionBinDo) LeftJoin(table schema.Tabler, on ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.LeftJoin(table, on...))
}

func (m minionBinDo) RightJoin(table schema.Tabler, on ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.RightJoin(table, on...))
}

func (m minionBinDo) Group(cols ...field.Expr) IMinionBinDo {
	return m.withDO(m.DO.Group(cols...))
}

func (m minionBinDo) Having(conds ...gen.Condition) IMinionBinDo {
	return m.withDO(m.DO.Having(conds...))
}

func (m minionBinDo) Limit(limit int) IMinionBinDo {
	return m.withDO(m.DO.Limit(limit))
}

func (m minionBinDo) Offset(offset int) IMinionBinDo {
	return m.withDO(m.DO.Offset(offset))
}

func (m minionBinDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionBinDo {
	return m.withDO(m.DO.Scopes(funcs...))
}

func (m minionBinDo) Unscoped() IMinionBinDo {
...
func (m minionBinDo) Attrs(attrs ...field.AssignExpr) IMinionBinDo {
	return m.withDO(m.DO.Attrs(attrs...))
}

func (m minionBinDo) Assign(attrs ...field.AssignExpr) IMinionBinDo {
	return m.withDO(m.DO.Assign(attrs...))
}

func (m minionBinDo) Joins(fields ...field.RelationField) IMinionBinDo {
...
func (m minionBinDo) Preload(fields ...field.RelationField) IMinionBinDo {
	for _, _f := range fields {

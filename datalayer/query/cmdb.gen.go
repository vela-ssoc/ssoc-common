...
func (c *cmdb) WithContext(ctx context.Context) ICmdbDo { return c.cmdbDo.WithContext(ctx) }
...
type ICmdbDo interface {
	gen.SubQuery
	Debug() ICmdbDo
	WithContext(ctx context.Context) ICmdbDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ICmdbDo
	WriteDB() ICmdbDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ICmdbDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ICmdbDo
	Not(conds ...gen.Condition) ICmdbDo
	Or(conds ...gen.Condition) ICmdbDo
	Select(conds ...field.Expr) ICmdbDo
	Where(conds ...gen.Condition) ICmdbDo
	Order(conds ...field.Expr) ICmdbDo
	Distinct(cols ...field.Expr) ICmdbDo
	Omit(cols ...field.Expr) ICmdbDo
	Join(table schema.Tabler, on ...field.Expr) ICmdbDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ICmdbDo
	RightJoin(table schema.Tabler, on ...field.Expr) ICmdbDo
	Group(cols ...field.Expr) ICmdbDo
	Having(conds ...gen.Condition) ICmdbDo
	Limit(limit int) ICmdbDo
	Offset(offset int) ICmdbDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ICmdbDo
	Unscoped() ICmdbDo
	Create(values ...*model.Cmdb) error
	CreateInBatches(values []*model.Cmdb, batchSize int) error
	Save(values ...*model.Cmdb) error
	First() (*model.Cmdb, error)
	Take() (*model.Cmdb, error)
	Last() (*model.Cmdb, error)
	Find() ([]*model.Cmdb, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Cmdb, err error)
	FindInBatches(result *[]*model.Cmdb, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Cmdb) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ICmdbDo
	Assign(attrs ...field.AssignExpr) ICmdbDo
	Joins(fields ...field.RelationField) ICmdbDo
	Preload(fields ...field.RelationField) ICmdbDo
	FirstOrInit() (*model.Cmdb, error)
	FirstOrCreate() (*model.Cmdb, error)
	FindByPage(offset int, limit int) (result []*model.Cmdb, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ICmdbDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (c cmdbDo) Debug() ICmdbDo {
	return c.withDO(c.DO.Debug())
}

func (c cmdbDo) WithContext(ctx context.Context) ICmdbDo {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c cmdbDo) ReadDB() ICmdbDo {
	return c.Clauses(dbresolver.Read)
}

func (c cmdbDo) WriteDB() ICmdbDo {
	return c.Clauses(dbresolver.Write)
}

func (c cmdbDo) Session(config *gorm.Session) ICmdbDo {
	return c.withDO(c.DO.Session(config))
}

func (c cmdbDo) Clauses(conds ...clause.Expression) ICmdbDo {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c cmdbDo) Returning(value interface{}, columns ...string) ICmdbDo {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c cmdbDo) Not(conds ...gen.Condition) ICmdbDo {
	return c.withDO(c.DO.Not(conds...))
}

func (c cmdbDo) Or(conds ...gen.Condition) ICmdbDo {
	return c.withDO(c.DO.Or(conds...))
}

func (c cmdbDo) Select(conds ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Select(conds...))
}

func (c cmdbDo) Where(conds ...gen.Condition) ICmdbDo {
	return c.withDO(c.DO.Where(conds...))
}

func (c cmdbDo) Order(conds ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Order(conds...))
}

func (c cmdbDo) Distinct(cols ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c cmdbDo) Omit(cols ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Omit(cols...))
}

func (c cmdbDo) Join(table schema.Tabler, on ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Join(table, on...))
}

func (c cmdbDo) LeftJoin(table schema.Tabler, on ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c cmdbDo) RightJoin(table schema.Tabler, on ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c cmdbDo) Group(cols ...field.Expr) ICmdbDo {
	return c.withDO(c.DO.Group(cols...))
}

func (c cmdbDo) Having(conds ...gen.Condition) ICmdbDo {
	return c.withDO(c.DO.Having(conds...))
}

func (c cmdbDo) Limit(limit int) ICmdbDo {
	return c.withDO(c.DO.Limit(limit))
}

func (c cmdbDo) Offset(offset int) ICmdbDo {
	return c.withDO(c.DO.Offset(offset))
}

func (c cmdbDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ICmdbDo {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c cmdbDo) Unscoped() ICmdbDo {
...
func (c cmdbDo) Attrs(attrs ...field.AssignExpr) ICmdbDo {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c cmdbDo) Assign(attrs ...field.AssignExpr) ICmdbDo {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c cmdbDo) Joins(fields ...field.RelationField) ICmdbDo {
...
func (c cmdbDo) Preload(fields ...field.RelationField) ICmdbDo {
	for _, _f := range fields {

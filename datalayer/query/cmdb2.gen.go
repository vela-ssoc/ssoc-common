...
func (c *cmdb2) WithContext(ctx context.Context) ICmdb2Do { return c.cmdb2Do.WithContext(ctx) }
...
type ICmdb2Do interface {
	gen.SubQuery
	Debug() ICmdb2Do
	WithContext(ctx context.Context) ICmdb2Do
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ICmdb2Do
	WriteDB() ICmdb2Do
	As(alias string) gen.Dao
	Session(config *gorm.Session) ICmdb2Do
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ICmdb2Do
	Not(conds ...gen.Condition) ICmdb2Do
	Or(conds ...gen.Condition) ICmdb2Do
	Select(conds ...field.Expr) ICmdb2Do
	Where(conds ...gen.Condition) ICmdb2Do
	Order(conds ...field.Expr) ICmdb2Do
	Distinct(cols ...field.Expr) ICmdb2Do
	Omit(cols ...field.Expr) ICmdb2Do
	Join(table schema.Tabler, on ...field.Expr) ICmdb2Do
	LeftJoin(table schema.Tabler, on ...field.Expr) ICmdb2Do
	RightJoin(table schema.Tabler, on ...field.Expr) ICmdb2Do
	Group(cols ...field.Expr) ICmdb2Do
	Having(conds ...gen.Condition) ICmdb2Do
	Limit(limit int) ICmdb2Do
	Offset(offset int) ICmdb2Do
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ICmdb2Do
	Unscoped() ICmdb2Do
	Create(values ...*model.Cmdb2) error
	CreateInBatches(values []*model.Cmdb2, batchSize int) error
	Save(values ...*model.Cmdb2) error
	First() (*model.Cmdb2, error)
	Take() (*model.Cmdb2, error)
	Last() (*model.Cmdb2, error)
	Find() ([]*model.Cmdb2, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Cmdb2, err error)
	FindInBatches(result *[]*model.Cmdb2, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Cmdb2) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ICmdb2Do
	Assign(attrs ...field.AssignExpr) ICmdb2Do
	Joins(fields ...field.RelationField) ICmdb2Do
	Preload(fields ...field.RelationField) ICmdb2Do
	FirstOrInit() (*model.Cmdb2, error)
	FirstOrCreate() (*model.Cmdb2, error)
	FindByPage(offset int, limit int) (result []*model.Cmdb2, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ICmdb2Do
...
func (c cmdb2Do) WithContext(ctx context.Context) ICmdb2Do {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c cmdb2Do) ReadDB() ICmdb2Do {
	return c.Clauses(dbresolver.Read)
}

func (c cmdb2Do) WriteDB() ICmdb2Do {
	return c.Clauses(dbresolver.Write)
}

func (c cmdb2Do) Session(config *gorm.Session) ICmdb2Do {
	return c.withDO(c.DO.Session(config))
}

func (c cmdb2Do) Clauses(conds ...clause.Expression) ICmdb2Do {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c cmdb2Do) Returning(value interface{}, columns ...string) ICmdb2Do {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c cmdb2Do) Not(conds ...gen.Condition) ICmdb2Do {
	return c.withDO(c.DO.Not(conds...))
}

func (c cmdb2Do) Or(conds ...gen.Condition) ICmdb2Do {
	return c.withDO(c.DO.Or(conds...))
}

func (c cmdb2Do) Select(conds ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Select(conds...))
}

func (c cmdb2Do) Where(conds ...gen.Condition) ICmdb2Do {
	return c.withDO(c.DO.Where(conds...))
}

func (c cmdb2Do) Order(conds ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Order(conds...))
}

func (c cmdb2Do) Distinct(cols ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c cmdb2Do) Omit(cols ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Omit(cols...))
}

func (c cmdb2Do) Join(table schema.Tabler, on ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Join(table, on...))
}

func (c cmdb2Do) LeftJoin(table schema.Tabler, on ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c cmdb2Do) RightJoin(table schema.Tabler, on ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c cmdb2Do) Group(cols ...field.Expr) ICmdb2Do {
	return c.withDO(c.DO.Group(cols...))
}

func (c cmdb2Do) Having(conds ...gen.Condition) ICmdb2Do {
	return c.withDO(c.DO.Having(conds...))
}

func (c cmdb2Do) Limit(limit int) ICmdb2Do {
	return c.withDO(c.DO.Limit(limit))
}

func (c cmdb2Do) Offset(offset int) ICmdb2Do {
	return c.withDO(c.DO.Offset(offset))
}

func (c cmdb2Do) Scopes(funcs ...func(gen.Dao) gen.Dao) ICmdb2Do {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c cmdb2Do) Unscoped() ICmdb2Do {
...
func (c cmdb2Do) Attrs(attrs ...field.AssignExpr) ICmdb2Do {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c cmdb2Do) Assign(attrs ...field.AssignExpr) ICmdb2Do {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c cmdb2Do) Joins(fields ...field.RelationField) ICmdb2Do {
...
func (c cmdb2Do) Preload(fields ...field.RelationField) ICmdb2Do {
	for _, _f := range fields {

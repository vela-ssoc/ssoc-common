...
func (v *vIP) WithContext(ctx context.Context) IVIPDo { return v.vIPDo.WithContext(ctx) }
...
type IVIPDo interface {
	gen.SubQuery
	Debug() IVIPDo
	WithContext(ctx context.Context) IVIPDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IVIPDo
	WriteDB() IVIPDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IVIPDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IVIPDo
	Not(conds ...gen.Condition) IVIPDo
	Or(conds ...gen.Condition) IVIPDo
	Select(conds ...field.Expr) IVIPDo
	Where(conds ...gen.Condition) IVIPDo
	Order(conds ...field.Expr) IVIPDo
	Distinct(cols ...field.Expr) IVIPDo
	Omit(cols ...field.Expr) IVIPDo
	Join(table schema.Tabler, on ...field.Expr) IVIPDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IVIPDo
	RightJoin(table schema.Tabler, on ...field.Expr) IVIPDo
	Group(cols ...field.Expr) IVIPDo
	Having(conds ...gen.Condition) IVIPDo
	Limit(limit int) IVIPDo
	Offset(offset int) IVIPDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IVIPDo
	Unscoped() IVIPDo
	Create(values ...*model.VIP) error
	CreateInBatches(values []*model.VIP, batchSize int) error
	Save(values ...*model.VIP) error
	First() (*model.VIP, error)
	Take() (*model.VIP, error)
	Last() (*model.VIP, error)
	Find() ([]*model.VIP, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.VIP, err error)
	FindInBatches(result *[]*model.VIP, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.VIP) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IVIPDo
	Assign(attrs ...field.AssignExpr) IVIPDo
	Joins(fields ...field.RelationField) IVIPDo
	Preload(fields ...field.RelationField) IVIPDo
	FirstOrInit() (*model.VIP, error)
	FirstOrCreate() (*model.VIP, error)
	FindByPage(offset int, limit int) (result []*model.VIP, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IVIPDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (v vIPDo) Debug() IVIPDo {
	return v.withDO(v.DO.Debug())
}

func (v vIPDo) WithContext(ctx context.Context) IVIPDo {
	return v.withDO(v.DO.WithContext(ctx))
}

func (v vIPDo) ReadDB() IVIPDo {
	return v.Clauses(dbresolver.Read)
}

func (v vIPDo) WriteDB() IVIPDo {
	return v.Clauses(dbresolver.Write)
}

func (v vIPDo) Session(config *gorm.Session) IVIPDo {
	return v.withDO(v.DO.Session(config))
}

func (v vIPDo) Clauses(conds ...clause.Expression) IVIPDo {
	return v.withDO(v.DO.Clauses(conds...))
}

func (v vIPDo) Returning(value interface{}, columns ...string) IVIPDo {
	return v.withDO(v.DO.Returning(value, columns...))
}

func (v vIPDo) Not(conds ...gen.Condition) IVIPDo {
	return v.withDO(v.DO.Not(conds...))
}

func (v vIPDo) Or(conds ...gen.Condition) IVIPDo {
	return v.withDO(v.DO.Or(conds...))
}

func (v vIPDo) Select(conds ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Select(conds...))
}

func (v vIPDo) Where(conds ...gen.Condition) IVIPDo {
	return v.withDO(v.DO.Where(conds...))
}

func (v vIPDo) Order(conds ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Order(conds...))
}

func (v vIPDo) Distinct(cols ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Distinct(cols...))
}

func (v vIPDo) Omit(cols ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Omit(cols...))
}

func (v vIPDo) Join(table schema.Tabler, on ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Join(table, on...))
}

func (v vIPDo) LeftJoin(table schema.Tabler, on ...field.Expr) IVIPDo {
	return v.withDO(v.DO.LeftJoin(table, on...))
}

func (v vIPDo) RightJoin(table schema.Tabler, on ...field.Expr) IVIPDo {
	return v.withDO(v.DO.RightJoin(table, on...))
}

func (v vIPDo) Group(cols ...field.Expr) IVIPDo {
	return v.withDO(v.DO.Group(cols...))
}

func (v vIPDo) Having(conds ...gen.Condition) IVIPDo {
	return v.withDO(v.DO.Having(conds...))
}

func (v vIPDo) Limit(limit int) IVIPDo {
	return v.withDO(v.DO.Limit(limit))
}

func (v vIPDo) Offset(offset int) IVIPDo {
	return v.withDO(v.DO.Offset(offset))
}

func (v vIPDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IVIPDo {
	return v.withDO(v.DO.Scopes(funcs...))
}

func (v vIPDo) Unscoped() IVIPDo {
...
func (v vIPDo) Attrs(attrs ...field.AssignExpr) IVIPDo {
	return v.withDO(v.DO.Attrs(attrs...))
}

func (v vIPDo) Assign(attrs ...field.AssignExpr) IVIPDo {
	return v.withDO(v.DO.Assign(attrs...))
}

func (v vIPDo) Joins(fields ...field.RelationField) IVIPDo {
...
func (v vIPDo) Preload(fields ...field.RelationField) IVIPDo {
	for _, _f := range fields {

...
func (s *sBOMVuln) WithContext(ctx context.Context) ISBOMVulnDo { return s.sBOMVulnDo.WithContext(ctx) }
...
type ISBOMVulnDo interface {
	gen.SubQuery
	Debug() ISBOMVulnDo
	WithContext(ctx context.Context) ISBOMVulnDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ISBOMVulnDo
	WriteDB() ISBOMVulnDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ISBOMVulnDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ISBOMVulnDo
	Not(conds ...gen.Condition) ISBOMVulnDo
	Or(conds ...gen.Condition) ISBOMVulnDo
	Select(conds ...field.Expr) ISBOMVulnDo
	Where(conds ...gen.Condition) ISBOMVulnDo
	Order(conds ...field.Expr) ISBOMVulnDo
	Distinct(cols ...field.Expr) ISBOMVulnDo
	Omit(cols ...field.Expr) ISBOMVulnDo
	Join(table schema.Tabler, on ...field.Expr) ISBOMVulnDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMVulnDo
	RightJoin(table schema.Tabler, on ...field.Expr) ISBOMVulnDo
	Group(cols ...field.Expr) ISBOMVulnDo
	Having(conds ...gen.Condition) ISBOMVulnDo
	Limit(limit int) ISBOMVulnDo
	Offset(offset int) ISBOMVulnDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMVulnDo
	Unscoped() ISBOMVulnDo
	Create(values ...*model.SBOMVuln) error
	CreateInBatches(values []*model.SBOMVuln, batchSize int) error
	Save(values ...*model.SBOMVuln) error
	First() (*model.SBOMVuln, error)
	Take() (*model.SBOMVuln, error)
	Last() (*model.SBOMVuln, error)
	Find() ([]*model.SBOMVuln, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SBOMVuln, err error)
	FindInBatches(result *[]*model.SBOMVuln, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SBOMVuln) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ISBOMVulnDo
	Assign(attrs ...field.AssignExpr) ISBOMVulnDo
	Joins(fields ...field.RelationField) ISBOMVulnDo
	Preload(fields ...field.RelationField) ISBOMVulnDo
	FirstOrInit() (*model.SBOMVuln, error)
	FirstOrCreate() (*model.SBOMVuln, error)
	FindByPage(offset int, limit int) (result []*model.SBOMVuln, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ISBOMVulnDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (s sBOMVulnDo) Debug() ISBOMVulnDo {
	return s.withDO(s.DO.Debug())
}

func (s sBOMVulnDo) WithContext(ctx context.Context) ISBOMVulnDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s sBOMVulnDo) ReadDB() ISBOMVulnDo {
	return s.Clauses(dbresolver.Read)
}

func (s sBOMVulnDo) WriteDB() ISBOMVulnDo {
	return s.Clauses(dbresolver.Write)
}

func (s sBOMVulnDo) Session(config *gorm.Session) ISBOMVulnDo {
	return s.withDO(s.DO.Session(config))
}

func (s sBOMVulnDo) Clauses(conds ...clause.Expression) ISBOMVulnDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s sBOMVulnDo) Returning(value interface{}, columns ...string) ISBOMVulnDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s sBOMVulnDo) Not(conds ...gen.Condition) ISBOMVulnDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s sBOMVulnDo) Or(conds ...gen.Condition) ISBOMVulnDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s sBOMVulnDo) Select(conds ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s sBOMVulnDo) Where(conds ...gen.Condition) ISBOMVulnDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s sBOMVulnDo) Order(conds ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s sBOMVulnDo) Distinct(cols ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s sBOMVulnDo) Omit(cols ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s sBOMVulnDo) Join(table schema.Tabler, on ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s sBOMVulnDo) LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s sBOMVulnDo) RightJoin(table schema.Tabler, on ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s sBOMVulnDo) Group(cols ...field.Expr) ISBOMVulnDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s sBOMVulnDo) Having(conds ...gen.Condition) ISBOMVulnDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s sBOMVulnDo) Limit(limit int) ISBOMVulnDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s sBOMVulnDo) Offset(offset int) ISBOMVulnDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s sBOMVulnDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMVulnDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s sBOMVulnDo) Unscoped() ISBOMVulnDo {
...
func (s sBOMVulnDo) Attrs(attrs ...field.AssignExpr) ISBOMVulnDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s sBOMVulnDo) Assign(attrs ...field.AssignExpr) ISBOMVulnDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s sBOMVulnDo) Joins(fields ...field.RelationField) ISBOMVulnDo {
...
func (s sBOMVulnDo) Preload(fields ...field.RelationField) ISBOMVulnDo {
	for _, _f := range fields {

...
func (m *minionListen) WithContext(ctx context.Context) IMinionListenDo {
...
type IMinionListenDo interface {
	gen.SubQuery
	Debug() IMinionListenDo
	WithContext(ctx context.Context) IMinionListenDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IMinionListenDo
	WriteDB() IMinionListenDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IMinionListenDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IMinionListenDo
	Not(conds ...gen.Condition) IMinionListenDo
	Or(conds ...gen.Condition) IMinionListenDo
	Select(conds ...field.Expr) IMinionListenDo
	Where(conds ...gen.Condition) IMinionListenDo
	Order(conds ...field.Expr) IMinionListenDo
	Distinct(cols ...field.Expr) IMinionListenDo
	Omit(cols ...field.Expr) IMinionListenDo
	Join(table schema.Tabler, on ...field.Expr) IMinionListenDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IMinionListenDo
	RightJoin(table schema.Tabler, on ...field.Expr) IMinionListenDo
	Group(cols ...field.Expr) IMinionListenDo
	Having(conds ...gen.Condition) IMinionListenDo
	Limit(limit int) IMinionListenDo
	Offset(offset int) IMinionListenDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionListenDo
	Unscoped() IMinionListenDo
	Create(values ...*model.MinionListen) error
	CreateInBatches(values []*model.MinionListen, batchSize int) error
	Save(values ...*model.MinionListen) error
	First() (*model.MinionListen, error)
	Take() (*model.MinionListen, error)
	Last() (*model.MinionListen, error)
	Find() ([]*model.MinionListen, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.MinionListen, err error)
	FindInBatches(result *[]*model.MinionListen, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.MinionListen) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IMinionListenDo
	Assign(attrs ...field.AssignExpr) IMinionListenDo
	Joins(fields ...field.RelationField) IMinionListenDo
	Preload(fields ...field.RelationField) IMinionListenDo
	FirstOrInit() (*model.MinionListen, error)
	FirstOrCreate() (*model.MinionListen, error)
	FindByPage(offset int, limit int) (result []*model.MinionListen, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IMinionListenDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (m minionListenDo) Debug() IMinionListenDo {
	return m.withDO(m.DO.Debug())
}

func (m minionListenDo) WithContext(ctx context.Context) IMinionListenDo {
	return m.withDO(m.DO.WithContext(ctx))
}

func (m minionListenDo) ReadDB() IMinionListenDo {
	return m.Clauses(dbresolver.Read)
}

func (m minionListenDo) WriteDB() IMinionListenDo {
	return m.Clauses(dbresolver.Write)
}

func (m minionListenDo) Session(config *gorm.Session) IMinionListenDo {
	return m.withDO(m.DO.Session(config))
}

func (m minionListenDo) Clauses(conds ...clause.Expression) IMinionListenDo {
	return m.withDO(m.DO.Clauses(conds...))
}

func (m minionListenDo) Returning(value interface{}, columns ...string) IMinionListenDo {
	return m.withDO(m.DO.Returning(value, columns...))
}

func (m minionListenDo) Not(conds ...gen.Condition) IMinionListenDo {
	return m.withDO(m.DO.Not(conds...))
}

func (m minionListenDo) Or(conds ...gen.Condition) IMinionListenDo {
	return m.withDO(m.DO.Or(conds...))
}

func (m minionListenDo) Select(conds ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Select(conds...))
}

func (m minionListenDo) Where(conds ...gen.Condition) IMinionListenDo {
	return m.withDO(m.DO.Where(conds...))
}

func (m minionListenDo) Order(conds ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Order(conds...))
}

func (m minionListenDo) Distinct(cols ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Distinct(cols...))
}

func (m minionListenDo) Omit(cols ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Omit(cols...))
}

func (m minionListenDo) Join(table schema.Tabler, on ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Join(table, on...))
}

func (m minionListenDo) LeftJoin(table schema.Tabler, on ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.LeftJoin(table, on...))
}

func (m minionListenDo) RightJoin(table schema.Tabler, on ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.RightJoin(table, on...))
}

func (m minionListenDo) Group(cols ...field.Expr) IMinionListenDo {
	return m.withDO(m.DO.Group(cols...))
}

func (m minionListenDo) Having(conds ...gen.Condition) IMinionListenDo {
	return m.withDO(m.DO.Having(conds...))
}

func (m minionListenDo) Limit(limit int) IMinionListenDo {
	return m.withDO(m.DO.Limit(limit))
}

func (m minionListenDo) Offset(offset int) IMinionListenDo {
	return m.withDO(m.DO.Offset(offset))
}

func (m minionListenDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionListenDo {
	return m.withDO(m.DO.Scopes(funcs...))
}

func (m minionListenDo) Unscoped() IMinionListenDo {
...
func (m minionListenDo) Attrs(attrs ...field.AssignExpr) IMinionListenDo {
	return m.withDO(m.DO.Attrs(attrs...))
}

func (m minionListenDo) Assign(attrs ...field.AssignExpr) IMinionListenDo {
	return m.withDO(m.DO.Assign(attrs...))
}

func (m minionListenDo) Joins(fields ...field.RelationField) IMinionListenDo {
...
func (m minionListenDo) Preload(fields ...field.RelationField) IMinionListenDo {
	for _, _f := range fields {

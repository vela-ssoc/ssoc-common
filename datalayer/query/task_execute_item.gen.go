...
func (t *taskExecuteItem) WithContext(ctx context.Context) ITaskExecuteItemDo {
...
type ITaskExecuteItemDo interface {
	gen.SubQuery
	Debug() ITaskExecuteItemDo
	WithContext(ctx context.Context) ITaskExecuteItemDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ITaskExecuteItemDo
	WriteDB() ITaskExecuteItemDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITaskExecuteItemDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ITaskExecuteItemDo
	Not(conds ...gen.Condition) ITaskExecuteItemDo
	Or(conds ...gen.Condition) ITaskExecuteItemDo
	Select(conds ...field.Expr) ITaskExecuteItemDo
	Where(conds ...gen.Condition) ITaskExecuteItemDo
	Order(conds ...field.Expr) ITaskExecuteItemDo
	Distinct(cols ...field.Expr) ITaskExecuteItemDo
	Omit(cols ...field.Expr) ITaskExecuteItemDo
	Join(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo
	RightJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo
	Group(cols ...field.Expr) ITaskExecuteItemDo
	Having(conds ...gen.Condition) ITaskExecuteItemDo
	Limit(limit int) ITaskExecuteItemDo
	Offset(offset int) ITaskExecuteItemDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ITaskExecuteItemDo
	Unscoped() ITaskExecuteItemDo
	Create(values ...*model.TaskExecuteItem) error
	CreateInBatches(values []*model.TaskExecuteItem, batchSize int) error
	Save(values ...*model.TaskExecuteItem) error
	First() (*model.TaskExecuteItem, error)
	Take() (*model.TaskExecuteItem, error)
	Last() (*model.TaskExecuteItem, error)
	Find() ([]*model.TaskExecuteItem, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TaskExecuteItem, err error)
	FindInBatches(result *[]*model.TaskExecuteItem, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TaskExecuteItem) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ITaskExecuteItemDo
	Assign(attrs ...field.AssignExpr) ITaskExecuteItemDo
	Joins(fields ...field.RelationField) ITaskExecuteItemDo
	Preload(fields ...field.RelationField) ITaskExecuteItemDo
	FirstOrInit() (*model.TaskExecuteItem, error)
	FirstOrCreate() (*model.TaskExecuteItem, error)
	FindByPage(offset int, limit int) (result []*model.TaskExecuteItem, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ITaskExecuteItemDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (t taskExecuteItemDo) Debug() ITaskExecuteItemDo {
	return t.withDO(t.DO.Debug())
}

func (t taskExecuteItemDo) WithContext(ctx context.Context) ITaskExecuteItemDo {
	return t.withDO(t.DO.WithContext(ctx))
}

func (t taskExecuteItemDo) ReadDB() ITaskExecuteItemDo {
	return t.Clauses(dbresolver.Read)
}

func (t taskExecuteItemDo) WriteDB() ITaskExecuteItemDo {
	return t.Clauses(dbresolver.Write)
}

func (t taskExecuteItemDo) Session(config *gorm.Session) ITaskExecuteItemDo {
	return t.withDO(t.DO.Session(config))
}

func (t taskExecuteItemDo) Clauses(conds ...clause.Expression) ITaskExecuteItemDo {
	return t.withDO(t.DO.Clauses(conds...))
}

func (t taskExecuteItemDo) Returning(value interface{}, columns ...string) ITaskExecuteItemDo {
	return t.withDO(t.DO.Returning(value, columns...))
}

func (t taskExecuteItemDo) Not(conds ...gen.Condition) ITaskExecuteItemDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t taskExecuteItemDo) Or(conds ...gen.Condition) ITaskExecuteItemDo {
	return t.withDO(t.DO.Or(conds...))
}

func (t taskExecuteItemDo) Select(conds ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Select(conds...))
}

func (t taskExecuteItemDo) Where(conds ...gen.Condition) ITaskExecuteItemDo {
	return t.withDO(t.DO.Where(conds...))
}

func (t taskExecuteItemDo) Order(conds ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Order(conds...))
}

func (t taskExecuteItemDo) Distinct(cols ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Distinct(cols...))
}

func (t taskExecuteItemDo) Omit(cols ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Omit(cols...))
}

func (t taskExecuteItemDo) Join(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Join(table, on...))
}

func (t taskExecuteItemDo) LeftJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.LeftJoin(table, on...))
}

func (t taskExecuteItemDo) RightJoin(table schema.Tabler, on ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.RightJoin(table, on...))
}

func (t taskExecuteItemDo) Group(cols ...field.Expr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Group(cols...))
}

func (t taskExecuteItemDo) Having(conds ...gen.Condition) ITaskExecuteItemDo {
	return t.withDO(t.DO.Having(conds...))
}

func (t taskExecuteItemDo) Limit(limit int) ITaskExecuteItemDo {
	return t.withDO(t.DO.Limit(limit))
}

func (t taskExecuteItemDo) Offset(offset int) ITaskExecuteItemDo {
	return t.withDO(t.DO.Offset(offset))
}

func (t taskExecuteItemDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ITaskExecuteItemDo {
	return t.withDO(t.DO.Scopes(funcs...))
}

func (t taskExecuteItemDo) Unscoped() ITaskExecuteItemDo {
...
func (t taskExecuteItemDo) Attrs(attrs ...field.AssignExpr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Attrs(attrs...))
}

func (t taskExecuteItemDo) Assign(attrs ...field.AssignExpr) ITaskExecuteItemDo {
	return t.withDO(t.DO.Assign(attrs...))
}

func (t taskExecuteItemDo) Joins(fields ...field.RelationField) ITaskExecuteItemDo {
...
func (t taskExecuteItemDo) Preload(fields ...field.RelationField) ITaskExecuteItemDo {
	for _, _f := range fields {

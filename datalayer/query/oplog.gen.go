...
func (o *oplog) WithContext(ctx context.Context) IOplogDo { return o.oplogDo.WithContext(ctx) }
...
type IOplogDo interface {
	gen.SubQuery
	Debug() IOplogDo
	WithContext(ctx context.Context) IOplogDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IOplogDo
	WriteDB() IOplogDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IOplogDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IOplogDo
	Not(conds ...gen.Condition) IOplogDo
	Or(conds ...gen.Condition) IOplogDo
	Select(conds ...field.Expr) IOplogDo
	Where(conds ...gen.Condition) IOplogDo
	Order(conds ...field.Expr) IOplogDo
	Distinct(cols ...field.Expr) IOplogDo
	Omit(cols ...field.Expr) IOplogDo
	Join(table schema.Tabler, on ...field.Expr) IOplogDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IOplogDo
	RightJoin(table schema.Tabler, on ...field.Expr) IOplogDo
	Group(cols ...field.Expr) IOplogDo
	Having(conds ...gen.Condition) IOplogDo
	Limit(limit int) IOplogDo
	Offset(offset int) IOplogDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IOplogDo
	Unscoped() IOplogDo
	Create(values ...*model.Oplog) error
	CreateInBatches(values []*model.Oplog, batchSize int) error
	Save(values ...*model.Oplog) error
	First() (*model.Oplog, error)
	Take() (*model.Oplog, error)
	Last() (*model.Oplog, error)
	Find() ([]*model.Oplog, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Oplog, err error)
	FindInBatches(result *[]*model.Oplog, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Oplog) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IOplogDo
	Assign(attrs ...field.AssignExpr) IOplogDo
	Joins(fields ...field.RelationField) IOplogDo
	Preload(fields ...field.RelationField) IOplogDo
	FirstOrInit() (*model.Oplog, error)
	FirstOrCreate() (*model.Oplog, error)
	FindByPage(offset int, limit int) (result []*model.Oplog, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IOplogDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (o oplogDo) Debug() IOplogDo {
	return o.withDO(o.DO.Debug())
}

func (o oplogDo) WithContext(ctx context.Context) IOplogDo {
	return o.withDO(o.DO.WithContext(ctx))
}

func (o oplogDo) ReadDB() IOplogDo {
	return o.Clauses(dbresolver.Read)
}

func (o oplogDo) WriteDB() IOplogDo {
	return o.Clauses(dbresolver.Write)
}

func (o oplogDo) Session(config *gorm.Session) IOplogDo {
	return o.withDO(o.DO.Session(config))
}

func (o oplogDo) Clauses(conds ...clause.Expression) IOplogDo {
	return o.withDO(o.DO.Clauses(conds...))
}

func (o oplogDo) Returning(value interface{}, columns ...string) IOplogDo {
	return o.withDO(o.DO.Returning(value, columns...))
}

func (o oplogDo) Not(conds ...gen.Condition) IOplogDo {
	return o.withDO(o.DO.Not(conds...))
}

func (o oplogDo) Or(conds ...gen.Condition) IOplogDo {
	return o.withDO(o.DO.Or(conds...))
}

func (o oplogDo) Select(conds ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Select(conds...))
}

func (o oplogDo) Where(conds ...gen.Condition) IOplogDo {
	return o.withDO(o.DO.Where(conds...))
}

func (o oplogDo) Order(conds ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Order(conds...))
}

func (o oplogDo) Distinct(cols ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Distinct(cols...))
}

func (o oplogDo) Omit(cols ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Omit(cols...))
}

func (o oplogDo) Join(table schema.Tabler, on ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Join(table, on...))
}

func (o oplogDo) LeftJoin(table schema.Tabler, on ...field.Expr) IOplogDo {
	return o.withDO(o.DO.LeftJoin(table, on...))
}

func (o oplogDo) RightJoin(table schema.Tabler, on ...field.Expr) IOplogDo {
	return o.withDO(o.DO.RightJoin(table, on...))
}

func (o oplogDo) Group(cols ...field.Expr) IOplogDo {
	return o.withDO(o.DO.Group(cols...))
}

func (o oplogDo) Having(conds ...gen.Condition) IOplogDo {
	return o.withDO(o.DO.Having(conds...))
}

func (o oplogDo) Limit(limit int) IOplogDo {
	return o.withDO(o.DO.Limit(limit))
}

func (o oplogDo) Offset(offset int) IOplogDo {
	return o.withDO(o.DO.Offset(offset))
}

func (o oplogDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IOplogDo {
	return o.withDO(o.DO.Scopes(funcs...))
}

func (o oplogDo) Unscoped() IOplogDo {
...
func (o oplogDo) Attrs(attrs ...field.AssignExpr) IOplogDo {
	return o.withDO(o.DO.Attrs(attrs...))
}

func (o oplogDo) Assign(attrs ...field.AssignExpr) IOplogDo {
	return o.withDO(o.DO.Assign(attrs...))
}

func (o oplogDo) Joins(fields ...field.RelationField) IOplogDo {
...
func (o oplogDo) Preload(fields ...field.RelationField) IOplogDo {
	for _, _f := range fields {

...
func (t *third) WithContext(ctx context.Context) IThirdDo { return t.thirdDo.WithContext(ctx) }
...
type IThirdDo interface {
	gen.SubQuery
	Debug() IThirdDo
	WithContext(ctx context.Context) IThirdDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IThirdDo
	WriteDB() IThirdDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IThirdDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IThirdDo
	Not(conds ...gen.Condition) IThirdDo
	Or(conds ...gen.Condition) IThirdDo
	Select(conds ...field.Expr) IThirdDo
	Where(conds ...gen.Condition) IThirdDo
	Order(conds ...field.Expr) IThirdDo
	Distinct(cols ...field.Expr) IThirdDo
	Omit(cols ...field.Expr) IThirdDo
	Join(table schema.Tabler, on ...field.Expr) IThirdDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IThirdDo
	RightJoin(table schema.Tabler, on ...field.Expr) IThirdDo
	Group(cols ...field.Expr) IThirdDo
	Having(conds ...gen.Condition) IThirdDo
	Limit(limit int) IThirdDo
	Offset(offset int) IThirdDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IThirdDo
	Unscoped() IThirdDo
	Create(values ...*model.Third) error
	CreateInBatches(values []*model.Third, batchSize int) error
	Save(values ...*model.Third) error
	First() (*model.Third, error)
	Take() (*model.Third, error)
	Last() (*model.Third, error)
	Find() ([]*model.Third, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Third, err error)
	FindInBatches(result *[]*model.Third, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Third) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IThirdDo
	Assign(attrs ...field.AssignExpr) IThirdDo
	Joins(fields ...field.RelationField) IThirdDo
	Preload(fields ...field.RelationField) IThirdDo
	FirstOrInit() (*model.Third, error)
	FirstOrCreate() (*model.Third, error)
	FindByPage(offset int, limit int) (result []*model.Third, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IThirdDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (t thirdDo) Debug() IThirdDo {
	return t.withDO(t.DO.Debug())
}

func (t thirdDo) WithContext(ctx context.Context) IThirdDo {
	return t.withDO(t.DO.WithContext(ctx))
}

func (t thirdDo) ReadDB() IThirdDo {
	return t.Clauses(dbresolver.Read)
}

func (t thirdDo) WriteDB() IThirdDo {
	return t.Clauses(dbresolver.Write)
}

func (t thirdDo) Session(config *gorm.Session) IThirdDo {
	return t.withDO(t.DO.Session(config))
}

func (t thirdDo) Clauses(conds ...clause.Expression) IThirdDo {
	return t.withDO(t.DO.Clauses(conds...))
}

func (t thirdDo) Returning(value interface{}, columns ...string) IThirdDo {
	return t.withDO(t.DO.Returning(value, columns...))
}

func (t thirdDo) Not(conds ...gen.Condition) IThirdDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t thirdDo) Or(conds ...gen.Condition) IThirdDo {
	return t.withDO(t.DO.Or(conds...))
}

func (t thirdDo) Select(conds ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Select(conds...))
}

func (t thirdDo) Where(conds ...gen.Condition) IThirdDo {
	return t.withDO(t.DO.Where(conds...))
}

func (t thirdDo) Order(conds ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Order(conds...))
}

func (t thirdDo) Distinct(cols ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Distinct(cols...))
}

func (t thirdDo) Omit(cols ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Omit(cols...))
}

func (t thirdDo) Join(table schema.Tabler, on ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Join(table, on...))
}

func (t thirdDo) LeftJoin(table schema.Tabler, on ...field.Expr) IThirdDo {
	return t.withDO(t.DO.LeftJoin(table, on...))
}

func (t thirdDo) RightJoin(table schema.Tabler, on ...field.Expr) IThirdDo {
	return t.withDO(t.DO.RightJoin(table, on...))
}

func (t thirdDo) Group(cols ...field.Expr) IThirdDo {
	return t.withDO(t.DO.Group(cols...))
}

func (t thirdDo) Having(conds ...gen.Condition) IThirdDo {
	return t.withDO(t.DO.Having(conds...))
}

func (t thirdDo) Limit(limit int) IThirdDo {
	return t.withDO(t.DO.Limit(limit))
}

func (t thirdDo) Offset(offset int) IThirdDo {
	return t.withDO(t.DO.Offset(offset))
}

func (t thirdDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IThirdDo {
	return t.withDO(t.DO.Scopes(funcs...))
}

func (t thirdDo) Unscoped() IThirdDo {
...
func (t thirdDo) Attrs(attrs ...field.AssignExpr) IThirdDo {
	return t.withDO(t.DO.Attrs(attrs...))
}

func (t thirdDo) Assign(attrs ...field.AssignExpr) IThirdDo {
	return t.withDO(t.DO.Assign(attrs...))
}

func (t thirdDo) Joins(fields ...field.RelationField) IThirdDo {
...
func (t thirdDo) Preload(fields ...field.RelationField) IThirdDo {
	for _, _f := range fields {

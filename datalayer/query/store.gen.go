...
type IStoreDo interface {
	...
	Unscoped() IStoreDo
	Create(values ...*model.Store) error
	CreateInBatches(values []*model.Store, batchSize int) error
	Save(values ...*model.Store) error
	First() (*model.Store, error)
	Take() (*model.Store, error)
	Last() (*model.Store, error)
	Find() ([]*model.Store, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Store, err error)
	FindInBatches(result *[]*model.Store, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Store) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Store, error)
	FirstOrCreate() (*model.Store, error)
	FindByPage(offset int, limit int) (result []*model.Store, count int64, err error)

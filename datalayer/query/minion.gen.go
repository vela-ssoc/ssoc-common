...
func (m *minion) WithContext(ctx context.Context) IMinionDo { return m.minionDo.WithContext(ctx) }
...
type IMinionDo interface {
	gen.SubQuery
	Debug() IMinionDo
	WithContext(ctx context.Context) IMinionDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IMinionDo
	WriteDB() IMinionDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IMinionDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IMinionDo
	Not(conds ...gen.Condition) IMinionDo
	Or(conds ...gen.Condition) IMinionDo
	Select(conds ...field.Expr) IMinionDo
	Where(conds ...gen.Condition) IMinionDo
	Order(conds ...field.Expr) IMinionDo
	Distinct(cols ...field.Expr) IMinionDo
	Omit(cols ...field.Expr) IMinionDo
	Join(table schema.Tabler, on ...field.Expr) IMinionDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IMinionDo
	RightJoin(table schema.Tabler, on ...field.Expr) IMinionDo
	Group(cols ...field.Expr) IMinionDo
	Having(conds ...gen.Condition) IMinionDo
	Limit(limit int) IMinionDo
	Offset(offset int) IMinionDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionDo
	Unscoped() IMinionDo
	Create(values ...*model.Minion) error
	CreateInBatches(values []*model.Minion, batchSize int) error
	Save(values ...*model.Minion) error
	First() (*model.Minion, error)
	Take() (*model.Minion, error)
	Last() (*model.Minion, error)
	Find() ([]*model.Minion, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Minion, err error)
	FindInBatches(result *[]*model.Minion, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Minion) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IMinionDo
	Assign(attrs ...field.AssignExpr) IMinionDo
	Joins(fields ...field.RelationField) IMinionDo
	Preload(fields ...field.RelationField) IMinionDo
	FirstOrInit() (*model.Minion, error)
	FirstOrCreate() (*model.Minion, error)
	FindByPage(offset int, limit int) (result []*model.Minion, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IMinionDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (m minionDo) Debug() IMinionDo {
	return m.withDO(m.DO.Debug())
}

func (m minionDo) WithContext(ctx context.Context) IMinionDo {
	return m.withDO(m.DO.WithContext(ctx))
}

func (m minionDo) ReadDB() IMinionDo {
	return m.Clauses(dbresolver.Read)
}

func (m minionDo) WriteDB() IMinionDo {
	return m.Clauses(dbresolver.Write)
}

func (m minionDo) Session(config *gorm.Session) IMinionDo {
	return m.withDO(m.DO.Session(config))
}

func (m minionDo) Clauses(conds ...clause.Expression) IMinionDo {
	return m.withDO(m.DO.Clauses(conds...))
}

func (m minionDo) Returning(value interface{}, columns ...string) IMinionDo {
	return m.withDO(m.DO.Returning(value, columns...))
}

func (m minionDo) Not(conds ...gen.Condition) IMinionDo {
	return m.withDO(m.DO.Not(conds...))
}

func (m minionDo) Or(conds ...gen.Condition) IMinionDo {
	return m.withDO(m.DO.Or(conds...))
}

func (m minionDo) Select(conds ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Select(conds...))
}

func (m minionDo) Where(conds ...gen.Condition) IMinionDo {
	return m.withDO(m.DO.Where(conds...))
}

func (m minionDo) Order(conds ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Order(conds...))
}

func (m minionDo) Distinct(cols ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Distinct(cols...))
}

func (m minionDo) Omit(cols ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Omit(cols...))
}

func (m minionDo) Join(table schema.Tabler, on ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Join(table, on...))
}

func (m minionDo) LeftJoin(table schema.Tabler, on ...field.Expr) IMinionDo {
	return m.withDO(m.DO.LeftJoin(table, on...))
}

func (m minionDo) RightJoin(table schema.Tabler, on ...field.Expr) IMinionDo {
	return m.withDO(m.DO.RightJoin(table, on...))
}

func (m minionDo) Group(cols ...field.Expr) IMinionDo {
	return m.withDO(m.DO.Group(cols...))
}

func (m minionDo) Having(conds ...gen.Condition) IMinionDo {
	return m.withDO(m.DO.Having(conds...))
}

func (m minionDo) Limit(limit int) IMinionDo {
	return m.withDO(m.DO.Limit(limit))
}

func (m minionDo) Offset(offset int) IMinionDo {
	return m.withDO(m.DO.Offset(offset))
}

func (m minionDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IMinionDo {
	return m.withDO(m.DO.Scopes(funcs...))
}

func (m minionDo) Unscoped() IMinionDo {
...
func (m minionDo) Attrs(attrs ...field.AssignExpr) IMinionDo {
	return m.withDO(m.DO.Attrs(attrs...))
}

func (m minionDo) Assign(attrs ...field.AssignExpr) IMinionDo {
	return m.withDO(m.DO.Assign(attrs...))
}

func (m minionDo) Joins(fields ...field.RelationField) IMinionDo {
...
func (m minionDo) Preload(fields ...field.RelationField) IMinionDo {
	for _, _f := range fields {

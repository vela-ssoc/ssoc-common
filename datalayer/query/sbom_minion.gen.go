...
func (s *sBOMMinion) WithContext(ctx context.Context) ISBOMMinionDo {
...
type ISBOMMinionDo interface {
	gen.SubQuery
	Debug() ISBOMMinionDo
	WithContext(ctx context.Context) ISBOMMinionDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ISBOMMinionDo
	WriteDB() ISBOMMinionDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ISBOMMinionDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ISBOMMinionDo
	Not(conds ...gen.Condition) ISBOMMinionDo
	Or(conds ...gen.Condition) ISBOMMinionDo
	Select(conds ...field.Expr) ISBOMMinionDo
	Where(conds ...gen.Condition) ISBOMMinionDo
	Order(conds ...field.Expr) ISBOMMinionDo
	Distinct(cols ...field.Expr) ISBOMMinionDo
	Omit(cols ...field.Expr) ISBOMMinionDo
	Join(table schema.Tabler, on ...field.Expr) ISBOMMinionDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMMinionDo
	RightJoin(table schema.Tabler, on ...field.Expr) ISBOMMinionDo
	Group(cols ...field.Expr) ISBOMMinionDo
	Having(conds ...gen.Condition) ISBOMMinionDo
	Limit(limit int) ISBOMMinionDo
	Offset(offset int) ISBOMMinionDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMMinionDo
	Unscoped() ISBOMMinionDo
	Create(values ...*model.SBOMMinion) error
	CreateInBatches(values []*model.SBOMMinion, batchSize int) error
	Save(values ...*model.SBOMMinion) error
	First() (*model.SBOMMinion, error)
	Take() (*model.SBOMMinion, error)
	Last() (*model.SBOMMinion, error)
	Find() ([]*model.SBOMMinion, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SBOMMinion, err error)
	FindInBatches(result *[]*model.SBOMMinion, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SBOMMinion) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ISBOMMinionDo
	Assign(attrs ...field.AssignExpr) ISBOMMinionDo
	Joins(fields ...field.RelationField) ISBOMMinionDo
	Preload(fields ...field.RelationField) ISBOMMinionDo
	FirstOrInit() (*model.SBOMMinion, error)
	FirstOrCreate() (*model.SBOMMinion, error)
	FindByPage(offset int, limit int) (result []*model.SBOMMinion, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ISBOMMinionDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (s sBOMMinionDo) Debug() ISBOMMinionDo {
	return s.withDO(s.DO.Debug())
}

func (s sBOMMinionDo) WithContext(ctx context.Context) ISBOMMinionDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s sBOMMinionDo) ReadDB() ISBOMMinionDo {
	return s.Clauses(dbresolver.Read)
}

func (s sBOMMinionDo) WriteDB() ISBOMMinionDo {
	return s.Clauses(dbresolver.Write)
}

func (s sBOMMinionDo) Session(config *gorm.Session) ISBOMMinionDo {
	return s.withDO(s.DO.Session(config))
}

func (s sBOMMinionDo) Clauses(conds ...clause.Expression) ISBOMMinionDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s sBOMMinionDo) Returning(value interface{}, columns ...string) ISBOMMinionDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s sBOMMinionDo) Not(conds ...gen.Condition) ISBOMMinionDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s sBOMMinionDo) Or(conds ...gen.Condition) ISBOMMinionDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s sBOMMinionDo) Select(conds ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s sBOMMinionDo) Where(conds ...gen.Condition) ISBOMMinionDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s sBOMMinionDo) Order(conds ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s sBOMMinionDo) Distinct(cols ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s sBOMMinionDo) Omit(cols ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s sBOMMinionDo) Join(table schema.Tabler, on ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s sBOMMinionDo) LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s sBOMMinionDo) RightJoin(table schema.Tabler, on ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s sBOMMinionDo) Group(cols ...field.Expr) ISBOMMinionDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s sBOMMinionDo) Having(conds ...gen.Condition) ISBOMMinionDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s sBOMMinionDo) Limit(limit int) ISBOMMinionDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s sBOMMinionDo) Offset(offset int) ISBOMMinionDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s sBOMMinionDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMMinionDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s sBOMMinionDo) Unscoped() ISBOMMinionDo {
...
func (s sBOMMinionDo) Attrs(attrs ...field.AssignExpr) ISBOMMinionDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s sBOMMinionDo) Assign(attrs ...field.AssignExpr) ISBOMMinionDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s sBOMMinionDo) Joins(fields ...field.RelationField) ISBOMMinionDo {
...
func (s sBOMMinionDo) Preload(fields ...field.RelationField) ISBOMMinionDo {
	for _, _f := range fields {

...
func (e *effect) WithContext(ctx context.Context) IEffectDo { return e.effectDo.WithContext(ctx) }
...
type IEffectDo interface {
	gen.SubQuery
	Debug() IEffectDo
	WithContext(ctx context.Context) IEffectDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() IEffectDo
	WriteDB() IEffectDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) IEffectDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) IEffectDo
	Not(conds ...gen.Condition) IEffectDo
	Or(conds ...gen.Condition) IEffectDo
	Select(conds ...field.Expr) IEffectDo
	Where(conds ...gen.Condition) IEffectDo
	Order(conds ...field.Expr) IEffectDo
	Distinct(cols ...field.Expr) IEffectDo
	Omit(cols ...field.Expr) IEffectDo
	Join(table schema.Tabler, on ...field.Expr) IEffectDo
	LeftJoin(table schema.Tabler, on ...field.Expr) IEffectDo
	RightJoin(table schema.Tabler, on ...field.Expr) IEffectDo
	Group(cols ...field.Expr) IEffectDo
	Having(conds ...gen.Condition) IEffectDo
	Limit(limit int) IEffectDo
	Offset(offset int) IEffectDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) IEffectDo
	Unscoped() IEffectDo
	Create(values ...*model.Effect) error
	CreateInBatches(values []*model.Effect, batchSize int) error
	Save(values ...*model.Effect) error
	First() (*model.Effect, error)
	Take() (*model.Effect, error)
	Last() (*model.Effect, error)
	Find() ([]*model.Effect, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Effect, err error)
	FindInBatches(result *[]*model.Effect, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Effect) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) IEffectDo
	Assign(attrs ...field.AssignExpr) IEffectDo
	Joins(fields ...field.RelationField) IEffectDo
	Preload(fields ...field.RelationField) IEffectDo
	FirstOrInit() (*model.Effect, error)
	FirstOrCreate() (*model.Effect, error)
	FindByPage(offset int, limit int) (result []*model.Effect, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) IEffectDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (e effectDo) Debug() IEffectDo {
	return e.withDO(e.DO.Debug())
}

func (e effectDo) WithContext(ctx context.Context) IEffectDo {
	return e.withDO(e.DO.WithContext(ctx))
}

func (e effectDo) ReadDB() IEffectDo {
	return e.Clauses(dbresolver.Read)
}

func (e effectDo) WriteDB() IEffectDo {
	return e.Clauses(dbresolver.Write)
}

func (e effectDo) Session(config *gorm.Session) IEffectDo {
	return e.withDO(e.DO.Session(config))
}

func (e effectDo) Clauses(conds ...clause.Expression) IEffectDo {
	return e.withDO(e.DO.Clauses(conds...))
}

func (e effectDo) Returning(value interface{}, columns ...string) IEffectDo {
	return e.withDO(e.DO.Returning(value, columns...))
}

func (e effectDo) Not(conds ...gen.Condition) IEffectDo {
	return e.withDO(e.DO.Not(conds...))
}

func (e effectDo) Or(conds ...gen.Condition) IEffectDo {
	return e.withDO(e.DO.Or(conds...))
}

func (e effectDo) Select(conds ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Select(conds...))
}

func (e effectDo) Where(conds ...gen.Condition) IEffectDo {
	return e.withDO(e.DO.Where(conds...))
}

func (e effectDo) Order(conds ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Order(conds...))
}

func (e effectDo) Distinct(cols ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Distinct(cols...))
}

func (e effectDo) Omit(cols ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Omit(cols...))
}

func (e effectDo) Join(table schema.Tabler, on ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Join(table, on...))
}

func (e effectDo) LeftJoin(table schema.Tabler, on ...field.Expr) IEffectDo {
	return e.withDO(e.DO.LeftJoin(table, on...))
}

func (e effectDo) RightJoin(table schema.Tabler, on ...field.Expr) IEffectDo {
	return e.withDO(e.DO.RightJoin(table, on...))
}

func (e effectDo) Group(cols ...field.Expr) IEffectDo {
	return e.withDO(e.DO.Group(cols...))
}

func (e effectDo) Having(conds ...gen.Condition) IEffectDo {
	return e.withDO(e.DO.Having(conds...))
}

func (e effectDo) Limit(limit int) IEffectDo {
	return e.withDO(e.DO.Limit(limit))
}

func (e effectDo) Offset(offset int) IEffectDo {
	return e.withDO(e.DO.Offset(offset))
}

func (e effectDo) Scopes(funcs ...func(gen.Dao) gen.Dao) IEffectDo {
	return e.withDO(e.DO.Scopes(funcs...))
}

func (e effectDo) Unscoped() IEffectDo {
...
func (e effectDo) Attrs(attrs ...field.AssignExpr) IEffectDo {
	return e.withDO(e.DO.Attrs(attrs...))
}

func (e effectDo) Assign(attrs ...field.AssignExpr) IEffectDo {
	return e.withDO(e.DO.Assign(attrs...))
}

func (e effectDo) Joins(fields ...field.RelationField) IEffectDo {
...
func (e effectDo) Preload(fields ...field.RelationField) IEffectDo {
	for _, _f := range fields {

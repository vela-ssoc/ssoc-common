...
func (s *sBOMProject) WithContext(ctx context.Context) ISBOMProjectDo {
...
type ISBOMProjectDo interface {
	gen.SubQuery
	Debug() ISBOMProjectDo
	WithContext(ctx context.Context) ISBOMProjectDo
	WithResult(fc func(tx gen.Dao)) gen.ResultInfo
	ReplaceDB(db *gorm.DB)
	ReadDB() ISBOMProjectDo
	WriteDB() ISBOMProjectDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ISBOMProjectDo
	Columns(cols ...field.Expr) gen.Columns
	Clauses(conds ...clause.Expression) ISBOMProjectDo
	Not(conds ...gen.Condition) ISBOMProjectDo
	Or(conds ...gen.Condition) ISBOMProjectDo
	Select(conds ...field.Expr) ISBOMProjectDo
	Where(conds ...gen.Condition) ISBOMProjectDo
	Order(conds ...field.Expr) ISBOMProjectDo
	Distinct(cols ...field.Expr) ISBOMProjectDo
	Omit(cols ...field.Expr) ISBOMProjectDo
	Join(table schema.Tabler, on ...field.Expr) ISBOMProjectDo
	LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMProjectDo
	RightJoin(table schema.Tabler, on ...field.Expr) ISBOMProjectDo
	Group(cols ...field.Expr) ISBOMProjectDo
	Having(conds ...gen.Condition) ISBOMProjectDo
	Limit(limit int) ISBOMProjectDo
	Offset(offset int) ISBOMProjectDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMProjectDo
	Unscoped() ISBOMProjectDo
	Create(values ...*model.SBOMProject) error
	CreateInBatches(values []*model.SBOMProject, batchSize int) error
	Save(values ...*model.SBOMProject) error
	First() (*model.SBOMProject, error)
	Take() (*model.SBOMProject, error)
	Last() (*model.SBOMProject, error)
	Find() ([]*model.SBOMProject, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SBOMProject, err error)
	FindInBatches(result *[]*model.SBOMProject, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SBOMProject) (info gen.ResultInfo, err error)
	...
	Attrs(attrs ...field.AssignExpr) ISBOMProjectDo
	Assign(attrs ...field.AssignExpr) ISBOMProjectDo
	Joins(fields ...field.RelationField) ISBOMProjectDo
	Preload(fields ...field.RelationField) ISBOMProjectDo
	FirstOrInit() (*model.SBOMProject, error)
	FirstOrCreate() (*model.SBOMProject, error)
	FindByPage(offset int, limit int) (result []*model.SBOMProject, count int64, err error)
	ScanByPage(result interface{}, offset int, limit int) (count int64, err error)
	Rows() (*sql.Rows, error)
	Row() *sql.Row
	Scan(result interface{}) (err error)
	Returning(value interface{}, columns ...string) ISBOMProjectDo
	UnderlyingDB() *gorm.DB
	schema.Tabler
}

func (s sBOMProjectDo) Debug() ISBOMProjectDo {
	return s.withDO(s.DO.Debug())
}

func (s sBOMProjectDo) WithContext(ctx context.Context) ISBOMProjectDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s sBOMProjectDo) ReadDB() ISBOMProjectDo {
	return s.Clauses(dbresolver.Read)
}

func (s sBOMProjectDo) WriteDB() ISBOMProjectDo {
	return s.Clauses(dbresolver.Write)
}

func (s sBOMProjectDo) Session(config *gorm.Session) ISBOMProjectDo {
	return s.withDO(s.DO.Session(config))
}

func (s sBOMProjectDo) Clauses(conds ...clause.Expression) ISBOMProjectDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s sBOMProjectDo) Returning(value interface{}, columns ...string) ISBOMProjectDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s sBOMProjectDo) Not(conds ...gen.Condition) ISBOMProjectDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s sBOMProjectDo) Or(conds ...gen.Condition) ISBOMProjectDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s sBOMProjectDo) Select(conds ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s sBOMProjectDo) Where(conds ...gen.Condition) ISBOMProjectDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s sBOMProjectDo) Order(conds ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s sBOMProjectDo) Distinct(cols ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s sBOMProjectDo) Omit(cols ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s sBOMProjectDo) Join(table schema.Tabler, on ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s sBOMProjectDo) LeftJoin(table schema.Tabler, on ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s sBOMProjectDo) RightJoin(table schema.Tabler, on ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s sBOMProjectDo) Group(cols ...field.Expr) ISBOMProjectDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s sBOMProjectDo) Having(conds ...gen.Condition) ISBOMProjectDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s sBOMProjectDo) Limit(limit int) ISBOMProjectDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s sBOMProjectDo) Offset(offset int) ISBOMProjectDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s sBOMProjectDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ISBOMProjectDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s sBOMProjectDo) Unscoped() ISBOMProjectDo {
...
func (s sBOMProjectDo) Attrs(attrs ...field.AssignExpr) ISBOMProjectDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s sBOMProjectDo) Assign(attrs ...field.AssignExpr) ISBOMProjectDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s sBOMProjectDo) Joins(fields ...field.RelationField) ISBOMProjectDo {
...
func (s sBOMProjectDo) Preload(fields ...field.RelationField) ISBOMProjectDo {
	for _, _f := range fields {
